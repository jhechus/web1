          ...
          <div className=' d-md-flex py-2 col-lg-6 px-3'>
            ...
            <div className="card cartaA text-md-center col-lg-6 col-md-6 h-100" >
              ...
              <div className="card-body">
                ...
                <p className="card-text justify"><strong> Muestreo y Analisis de fuentes fijas </strong> se realizan evaluaciones integrales en las que identificamos los contaminantes atmosféricos para definir su efecto en la calidad del aire. 
                <br />
