  ...
  return (
    <div>
      ...
      <div className=' container'>
        <div className=' cardsA d-lg-flex '>

          <div className=' d-md-flex py-2 col-lg-6 px-3'>  

              <div className="card cartaA text-md-center col-lg-6 col-md-6  h-75 " >
                <img className="card-img-top" src={FtAgua} alt="Card image cap" />
                <div className="card-body">
                  <h5 className="card-title"> Agua </h5>
                  <p className="justify"><strong> El muestreo y Análisis sobre el agua. </strong> Consiste en la extracción de una representativa de agua, cada cierto tiempo y en ciertas condiciones para analizarla y determinar las características que posee.  </p>
          ...
          <div className=' d-md-flex py-2 col-lg-6 px-3'>
            ...
            <div className="card cartaA text-md-center col-lg-6 col-md-6  h-100" >
              ...
              <div className="card-body">
                ...
                <p className="card-text justify"><strong> Los muestreos y análisis de alimentos </strong> se realizan en prevención de posibles problemas digestivos como intoxicaciones e infecciones y para la prevención de intolerancias y control nutricional de la composición alimentaria de los productos.
                <br /> 
            ...
            <div className="card cartaA text-md-center col-lg-6 col-md-6 h-100" >
              ...
              <div className="card-body">
                ...
                <p className="card-text justify"><strong> Muestreo y Análisis de fuentes fijas </strong> se realizan evaluaciones integrales en las que identificamos los contaminantes atmosféricos para definir su efecto en la calidad del aire. 
                <br />
